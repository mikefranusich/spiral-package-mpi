...
Class(GPUUnparser, CUnparser, rec(
    ...
    T_CudaEvent := (self, t, vars, i, is) >> 
        Print("DEVICE_EVENT_T ", self.infix(vars, ", ", i + is)),

    cu_event_create := (self, o, i, is) >> Print(Blanks(i), "DEVICE_EVENT_CREATE(", self(o.args[1], 0, 0), 
                            When(Length(o.args)>1 and not o.args[2].v, ")", ");\n")),

    cu_event_record := (self, o, i, is) >> Print(Blanks(i), "DEVICE_EVENT_RECORD(", self(o.args[1], 0, 0), 
                            When(Length(o.args)>1 and not o.args[2].v, ")", ");\n")),

    cu_event_destroy := (self, o, i, is) >> Print(Blanks(i), "DEVICE_EVENT_DESTROY(", self(o.args[1], 0, 0), 
                            When(Length(o.args)>1 and not o.args[2].v, ")", ");\n")),
<#
    ...
    cu_event_synchronize := (self, o, i, is) >> Print(Blanks(i), "cudaEventSynchronize(", self(o.args[1], 0, 0), 
                            When(Length(o.args)>1 and not o.args[2].v, ")", ");\n")),
#>
    cu_device_synchronize := (self, o, i, is) >> Print(Blanks(i), "DEVICE_SYNCHRONIZE(",
    ...
    specifiers_func := (self, o, i, is) >> let(
     ...
     cu_memcpy := (self, o, i, is) >> Print(Blanks(i),
        "DEVICE_MEM_COPY(", self(o.loc, 0, 0), ", ", self(o.exp, 0, 0), ", ", self(o.size, 0, 0), "*sizeof(", self.declare(o.loc.t.t,[], 0, 0), 
            "), ", o.kind, ");\n"),
...
#>
    cu_free := (self, o, i, is) >> Print(Blanks(i), "DEVICE_FREE(", self(o.args[1], 0, 0), ");\n"),
...
<#
GPUDefaults := CopyFields(SpiralDefaults, 
                                rec(
                                    globalUnrolling := 10,
                                    useDeref := false,
